...
def add_dish(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        print(f"Categoría recibida del form: {category_id}")
    ...
    return render_template('admin/add_dish.html', restaurant=restaurant, categories=categories)
...
def edit_dish(dish_id):
    ...
    categories = Category.query.all()
    return render_template('admin/edit_dish.html', dish=dto, restaurant=restaurant, categories=categories)
